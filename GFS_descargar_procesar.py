...
for i in range(len(file_id_list)):
    ...
    data_url = "https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25.pl?file=gfs.t06z.pgrb2.0p25.f" + file_id_list[i] + "&all_lev=on&var_APCP=on&subregion=&leftlon=282&rightlon=299&toplat=24&bottomlat=13.5&dir=%2Fgfs." + input_datetime
