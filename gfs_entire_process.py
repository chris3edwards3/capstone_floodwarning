...
Hours_00_06 = current_directory + "/gfs_apcp_" + input_datetime + "/gfs_apcp_" + input_datetime + "_f006.grb"
Hrs00_06 = QgsRasterLayer(Hours_00_06,"Hours 00 to 06")

Hours_06_12 = current_directory + "/gfs_apcp_" + input_datetime + "/gfs_apcp_" + input_datetime + "_f012.grb"
Hrs06_12 = QgsRasterLayer(Hours_06_12,"Hours 06 to 12")

Hours_12_18 = current_directory + "/gfs_apcp_" + input_datetime + "/gfs_apcp_" + input_datetime + "_f018.grb"
Hrs12_18 = QgsRasterLayer(Hours_12_18,"Hours 12 to 18")

Hours_18_24 = current_directory + "/gfs_apcp_" + input_datetime + "/gfs_apcp_" + input_datetime + "_f024.grb"
...
daily_total_0_24 = current_directory + "/gfs_apcp_" + input_datetime + "/gfs_apcp_" + input_datetime + "Hrs00_24_daily_total.tif" 
...
Hours_24_30 = current_directory + "/gfs_apcp_" + input_datetime + "/gfs_apcp_" + input_datetime + "_f030.grb"
Hrs24_30 = QgsRasterLayer(Hours_24_30,"Hours 24 to 30")

Hours_30_36 = current_directory + "/gfs_apcp_" + input_datetime + "/gfs_apcp_" + input_datetime + "_f036.grb"
Hrs30_36 = QgsRasterLayer(Hours_30_36,"Hours 30 to 36")

Hours_36_42 = current_directory + "/gfs_apcp_" + input_datetime + "/gfs_apcp_" + input_datetime + "_f042.grb"
Hrs36_42 = QgsRasterLayer(Hours_36_42,"Hours 36 to 42")

Hours_42_48 = current_directory + "/gfs_apcp_" + input_datetime + "/gfs_apcp_" + input_datetime + "_f048.grb"
...
daily_total_24_48 = current_directory + "/gfs_apcp_" + input_datetime + "/gfs_apcp_" + input_datetime + "_Hrs24_48_daily_total.tif" 
...
ffgs_filepath = 'C:/Users/User/Desktop/Capstone/Shapefiles/ffgs_basin_view.shp'		#edit path to match location of shapefile on user's device
ffgs = QgsVectorLayer('C:/Users/User/Desktop/Capstone/Shapefiles/ffgs_basin_view.shp','FFGS','ogr')		#Stores the shapefile layer as a variable
iface.addVectorLayer(ffgs_filepath, input_datetime,'ogr')		#add shapefile to the map and directory/list of layers
...
zoneStat = QgsZonalStatistics (ffgs, gfs_00to24, 'Hrs_00-24', 1, QgsZonalStatistics.Mean)
...
zoneStat = QgsZonalStatistics (ffgs, gfs_24to48, 'Hrs_24-48', 1, QgsZonalStatistics.Mean)
zoneStat.calculateStatistics(None)
